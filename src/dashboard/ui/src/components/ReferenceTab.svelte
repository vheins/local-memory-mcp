...
<div class="animate-fade-in">
    ...
    <div class="ref-header">
      <div class="flex items-center gap-2">
        ...
        {#if state.capabilities}
          <span class="ref-total-badge">{(state.capabilities.tools?.length || 0) + (state.capabilities.prompts?.length || 0)} items</span>
        {/if}
      </div>
      <!-- Quick Search -->
  ...
  <div class="ref-body">
    ...
    <div class="glass ref-sidebar">
      ...
      {#each [
        { id: 'all',     icon: 'layers',  label: 'All',     count: (state.capabilities?.tools?.length || 0) + (state.capabilities?.prompts?.length || 0) + (state.capabilities?.resources?.length || 0) },
        ...
        {#if tools.length > 0}
          ...
          <div class="ref-grid">
            {#each tools as tool}
              ...
              <div class="ref-card ref-card-tool animate-fade-in" on:click={() => handler.openReferenceDrawer('tool', tool)} role="button" tabindex="0">
        ...
        {#if prompts.length > 0}
          ...
          <div class="ref-grid">
            {#each prompts as prompt}
              <!-- svelte-ignore a11y-click-events-have-key-events tabindex-no-interactive-non-semantic-element -->
              <div class="ref-card ref-card-prompt animate-fade-in" on:click={() => handler.openReferenceDrawer('prompt', prompt)} role="button" tabindex="0">
                <div class="ref-card-top">
        ...
        {#if resources.length > 0}
          ...
          <div class="ref-grid">
            {#each resources as resource}
              <!-- svelte-ignore a11y-click-events-have-key-events tabindex-no-interactive-non-semantic-element -->
              <div class="ref-card ref-card-resource animate-fade-in" on:click={() => handler.openReferenceDrawer('resource', resource)} role="button" tabindex="0">
                <div class="ref-card-top">
