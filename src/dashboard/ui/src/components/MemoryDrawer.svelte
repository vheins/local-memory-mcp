        ...
        <div class="mem-form">
          ...
          <div>
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
              <label for="mem_content" class="form-label" style="margin-bottom:0;">Content * <span style="font-weight:400;color:var(--color-text-muted);">(Markdown supported)</span></label>
              <button
                type="button"
                class="btn btn-ghost btn-sm"
...
<style>
  ...
  .importance-ticks span { font-weight: 600; transition: color 0.2s; }
  .importance-ticks span.active { color: var(--color-text); }
