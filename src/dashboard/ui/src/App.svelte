<script lang="ts">
  ...
  import './app.css';
  import {
    theme, activeTab, currentRepo, recentActionsTotalItems,
    initPersistedState
  } from './lib/stores';
  ...
  const app = createAppHandler({
    get kanbanBoard() { return kanbanBoard; },
    get memoryList() { return memoryList; }
  });
...
<div class="app-layout">
  ...
  <div class="main-content" class:sidebar-collapsed={$sidebarCollapsed}>
    ...
    {#if $appState.mobileMenuOpen}
      ...
      <div class="drawer-overlay" style="z-index:38;" on:click={() => app.toggleMobileMenu()} role="button" tabindex="0"></div>
      ...
      {:else}
        ...
        {#if $activeTab === 'memories'}
          <div class="glass card hover-glow animate-fade-in">
            ...
            <MemoryList bind:this={memoryList} onMemoryClick={app.openMemoryDrawer} onNewMemory={app.openNewMemoryDrawer} onBulkImport={() => app.openBulkImport('memories')} />
          </div>
        {/if}
