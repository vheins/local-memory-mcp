...
Read-only tools are safe to auto-approve. Write tools (`memory-write`, `task-write`, etc.) should still require confirmation.
...
4. Try asking the Kiro agent:
   > _"What do you know about this project?"_
