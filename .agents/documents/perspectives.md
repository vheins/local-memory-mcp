...
- **Visualize Knowledge Graphs:** See how entities, technologies, and concepts in your project relate to each other through an interactive force-directed graph.
...
- **Task Lifecycle Awareness:** I can track my work through a structured lifecycle (backlog → pending → in_progress → completed), with token budgeting and audit trails for every transition.
- **Knowledge Graph Discovery:** I can explore relationships between entities in your project, understanding that "UserService" depends on "AuthMiddleware" which implements "JWTAuthInterface."
