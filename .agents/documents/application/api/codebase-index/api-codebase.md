...
| `../../modules/codebase-index/runbook.md`                        | Operations runbook                   |



---

## 9. Full Reference Details (from archived deep-dive)
