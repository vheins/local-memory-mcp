...
| 2   | Coverage suites     | `utils`/`routes`/`services`/`lib`/`prompts` + per-module floors (TST-006..011)   | `../../_tasks/testing-standardization.md` TST-006..012                                                                                                                            |
...
| 4   | Perf follow-ups     | Queue batch/backoff, `VECTOR_CANDIDATE_CAP`, `KG_MAX_*`, `WAL_CHECKPOINT` tuning | [`../../application/modules/codebase-index/specs/optimization-roadmap.md`](../../application/modules/codebase-index/specs/optimization-roadmap.md) · `src/mcp/utils/constants.ts` |
...
- Optimization: [`../../application/modules/codebase-index/specs/optimization-roadmap.md`](../../application/modules/codebase-index/specs/optimization-roadmap.md) · Testing: [`../../testing.md`](../../testing.md)
