...
| **S03** | CI gate — `ci.yml` (PR + main: type-check, lint, test --coverage blocking)        | —          | **PLANNED** | [`sprint-03.md`](sprint-03.md) · `../../_tasks/testing-standardization.md` TST-013                    |
...
- Legacy bridge: `../../_tasks/BRIDGE.md` (removed post-cutover)
