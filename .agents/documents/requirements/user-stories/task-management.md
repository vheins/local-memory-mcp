...
### 4. Guided Creation
- **As a** Developer, **I want** the agent to use `task-create-interactive` with elicitation when I provide vague directives, **so that** my tasks always have the necessary metadata (priority/phase) before starting.
