...
| Auditability (`action_log`)       | [FSD §8 Activity Audit](../fsd/core-features.md#8-activity-audit), [PRD NFR Traceability](../prd/local-memory-mcp.md#non-functional-requirements-nfrs)                         | [Operations runbook](../../_archive/operations/codebase-index.md#7-monitoring)                                                           |
